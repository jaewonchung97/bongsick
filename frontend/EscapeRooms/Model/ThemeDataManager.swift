...
final class ThemeDataManager {
    ...
    func makeThemeData() -> [TestTheme] {
        let themeData = [
            TestTheme(image: UIImage(named: "그림자 없는 상자.jpeg"), name: "그림자 없는 상자", company: "방탈출, 단편선", difficulty: "🎮🎮🎮", playTime: "75분" , personnel: "2인 ~ 4인",
                  story: """
                  "미안해 누나. 근데 내가 맞았어.
                  결국 끝도, 시작도 누나한테 달렸어."
            ...
            TestTheme(image: UIImage(named: "MAYDAY.jpeg"), name: "MAYDAY", company: "비트포비아 강남 던전Ⅱ", difficulty: "🎮🎮🎮🎮", playTime: "65분" , personnel: "2인 ~ 5인",
                  story: """
                  오랜 꿈이었던 우주연구원이 된 당신.
                  ...
                  """, price: "25000원", address: nil),
            TestTheme(image: UIImage(named: "강남목욕탕.jpeg"), name: "강남목욕탕", company: "비트포비아 강남 던전", difficulty: "🎮🎮", playTime: "60분" , personnel: "2인 ~ 5인",
                  story: """
                  ...
                  """, price: "25000원", address: nil),
            TestTheme(image: UIImage(named: "꿈의 공장.jpeg"), name: "꿈의 공장", company: "비트포비아 홍대 던전", difficulty: "🎮🎮🎮", playTime: "60분" , personnel: "2인 ~ 5인",
                  story: """
                  "OK 컷! 모두 수고하셨습니다!!!"
                  ...
                  """, price: "25000원", address: nil),
            TestTheme(image: UIImage(named: "전래동자살사건.png"), name: "전래동 자살사건", company: "비트포비아 던전101", difficulty: "🎮🎮🎮", playTime: "70분" , personnel: "2인 ~ 5인",
                  story: """
                  ...
                  """, price: "25000원", address: nil),
            TestTheme(image: UIImage(named: "MST엔터테인먼트.png"), name: "MST 엔터테인먼트", company: "비트포비아 던전101", difficulty: "🎮🎮🎮", playTime: "60분" , personnel: "2인 ~ 5인",
                  story: """
